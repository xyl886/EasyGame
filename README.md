...
基于 Vue 3 + Vite + TailwindCSS 构建的纯前端 Web 应用，内置 **九款经典益智游戏**，支持 PC / 手机浏览器，扫码即玩、离线可用。
...
- 🎯 **九款经典游戏**：2048、贪吃蛇（Snake）、俄罗斯方块（Tetris）、华容道（数字滑块 + 三国经典版）、数独、扫雷、连连看、消消乐、数字连连
...
- [x] 第七款游戏：连连看（简单/普通/困难三档棋盘，≤2 弯经典路径算法，水果/动物/表情三主题，提示/洗牌/连线动画）
- [x] 第八款游戏：消消乐（宝石/糖果/水果三主题，交换消除 + 重力下落 + 连锁连击计分，有限步数内达标即通关）
- [x] 第九款游戏：数字连连（1→N 顺序连线，4×4=16 到 8×8=64 关卡递进，计时计分冲最快纪录）
- [ ] 平滑迁移至微信小程序，双端同步
