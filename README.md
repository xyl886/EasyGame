...
- 🎯 **四款经典游戏**：2048、贪吃蛇（Snake）、俄罗斯方块（Tetris）、华容道（数字滑块 + 三国经典版）
...
- [x] 三款经典游戏：2048 / 贪吃蛇 / 俄罗斯方块（含设置、排行榜、撤销等）
- [x] PWA 离线使用（离线缓存 + 添加到桌面）
- [x] 游戏音效（Web Audio 合成 + 一键开关）+ 成绩分享（Web Share API）
- [x] 游戏自动存档（误退 / 刷新 / 切后台后可一键继续）
- [x] 第四款游戏：华容道（数字滑块 3×3~5×5 + 三国经典版「曹操逃生」，含横刀立马布局，设置内一键切换）
- [ ] 扩展至 5~6 款经典益智小游戏（扫雷 / 数独）
- [ ] 平滑迁移至微信小程序，双端同步
